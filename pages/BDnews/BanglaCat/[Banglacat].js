  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="বিষয় অনুযায়ী বাংলাদেশের প্রত্যেক দৈনিক পত্রিকা এবং অনলাইন পত্রিকার সর্বশেষ বাংলা সংবাদ"/>
        <meta name="title" content="বিষয় অনুযায়ী বাংলাদেশের প্রত্যেক দৈনিক পত্রিকা এবং অনলাইন পত্রিকার সর্বশেষ বাংলা সংবাদ"/>
        ...
        <meta property="og:title" content="বিষয় অনুযায়ী বাংলাদেশের প্রত্যেক দৈনিক পত্রিকা এবং অনলাইন পত্রিকার সর্বশেষ বাংলা সংবাদ" />
     ...
     crossOrigin="anonymous"></script>
      ...
      <section>
        <details>
          <summary className='btn btn-light button mt-3'>
            বিষয় পরিবর্তন করুন <IconContext.Provider value={{className:"fa-bounce"}}> <FaAngleDown/></IconContext.Provider>
          </summary>
          <p>
      ...
      <div className='b-block'>
        ...
        <form className=' d-flex justify-content-center align-items-center' onSubmit={handleSubmit}>
            <label>
            <div className='optiontitle mb-3 '>বিষয় পরিবর্তন করুন   </div>
